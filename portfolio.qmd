...
- Competition between **alignment-induced compaction** and **shear-induced dilatancy**  
- Links microstructure (particle alignment) to macroscopic surface deformation  
...
- Transition from shear-induced dilatancy (in spheres) to **alignment-induced compaction** (in elongated particles)  
...
[GitHub →](https://github.com/huzaifrahim/battery-digital-twin) · [Read more →](./projects/battery-digital-twin.qmd)
